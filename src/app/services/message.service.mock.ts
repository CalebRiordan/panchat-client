...
export class MockMessageService extends MessageService {
  override getLatestMessages(
    ...
    return of([
      ...
      {
        id: 'msg-002',
        deviceId: '6841269b-5f01-47c8-b8b0-7a58f732f941',
        userId: 'user-001',
        content: "I'm doing well, thanks for asking!",
        contentType: 'text',
        dateTimeSent: new Date('2026-01-25T08:20:00Z'),
        queueOrder: 2,
      },
      {
        id: 'msg-003',
      ...
      },
      {
        ...
        deviceId: '6841269b-5f01-47c8-b8b0-7a58f732f941',
        userId: 'user-001',
        content: 'Yes, I reviewed them this morning',
        contentType: 'text',
        dateTimeSent: new Date('2026-01-25T08:45:00Z'),
        queueOrder: 4,
      },
      {
        id: 'msg-005',
      ...
      },
      {
        ...
        deviceId: '6841269b-5f01-47c8-b8b0-7a58f732f941',
        userId: 'user-001',
        content: "Nice! That's the one from the conference?",
        contentType: 'text',
        dateTimeSent: new Date('2026-01-25T09:25:00Z'),
        queueOrder: 6,
      },
      {
        id: 'msg-007',
        deviceId: 'device-abc123',
        userId: 'user-001',
        content: 'Exactly! That sounds great!',
        contentType: 'text',
      ...
      },
      {
        ...
        deviceId: '6841269b-5f01-47c8-b8b0-7a58f732f941',
        userId: 'user-001',
        content: "Here's the summary document",
        contentType: 'text',
        dateTimeSent: new Date('2026-01-25T11:00:00Z'),
        queueOrder: 8,
      },
      {
        id: 'msg-009',
      ...
      },
      {
        ...
        deviceId: 'device-abc123',
        userId: 'user-001',
        content: 'Me too! Thanks for your help earlier!',
        contentType: 'text',
      ...
      },
      {
        ...
        deviceId: '6841269b-5f01-47c8-b8b0-7a58f732f941',
        userId: 'user-001',
        content: 'Sure, 3 PM works for me',
        contentType: 'text',
        dateTimeSent: new Date('2026-01-25T16:30:00Z'),
        queueOrder: 14,
      },
      {
        id: 'msg-015',
